...
beforeAll(async () => {
  ...
  mock.module("@foxybear/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@foxybear/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@foxybear/ui/icon", () => ({ Icon: () => null }))
  mock.module("@foxybear/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
