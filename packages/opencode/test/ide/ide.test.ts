...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders FBH_CALLER", () => {
    process.env["FBH_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode FBH_CALLER", () => {
    process.env["FBH_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown FBH_CALLER", () => {
    process.env["FBH_CALLER"] = "unknown"
