...
const dir = process.env.FBH_E2E_PROJECT_DIR ?? process.cwd()
const title = process.env.FBH_E2E_SESSION_TITLE ?? "E2E Session"
const text = process.env.FBH_E2E_MESSAGE ?? "Seeded for UI e2e"
const model = process.env.FBH_E2E_MODEL ?? "opencode/gpt-5-nano"
