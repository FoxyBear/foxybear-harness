...
import { FbhClient } from "./gen/sdk.gen.js"
export { type Config as FbhClientConfig, FbhClient }
...
export function createFbhClient(config?: Config & { directory?: string; experimental_workspaceID?: string }) {
  if (!config?.fetch) {
