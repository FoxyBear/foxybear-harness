...
export namespace Plugin {
  ...
  export class Service extends Context.Service<Service, Interface>()("@foxybear/Plugin") {}
    ...
    Effect.gen(function* () {
      ...
      const state = yield* InstanceState.make<State>(
        Effect.fn("Plugin.state")(function* (ctx) {
          ...
          const plugins = Flag.FBH_PURE ? [] : (cfg.plugin_origins ?? [])
          if (Flag.FBH_PURE && cfg.plugin_origins?.length) {
